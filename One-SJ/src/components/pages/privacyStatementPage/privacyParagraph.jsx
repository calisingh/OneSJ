      ...
      >
        ...
        <p>
          ...
          <p className="privacy">
            ...
            by log files includes referring/exit pages, time spent on the
            website, and the number of clicks on the components. The purpose of
            the information is for analyzing trends, administering the site, and
            tracking users' movement on the website.
          </p>
        </p>
        ...
        <p>
          ...
          <p className="privacy">
            ...
            the site. We encourage parents and guardians to observe, participate
