    ...
    <>
      ...
      >
        ...
        <p className="aboutUs">
          ...
          health but we plan to expand to food assistance, shelters, clothing,
          and financial help. You can find more information on the project,
          including the source code for replicating OneSJ on our Github page. We
          are affiliated with Mayor Sam Liccardo’s Office of Technology and
          Innovation (MOTI), which leverages technology to improve our
        ...
        <p className="aboutUs">
          ...
          data and your engineering/design feedback, Code for San José for your
          insights on designing for accessibility, and Google.org, SAP, and
          PayPal for providing mentorship and helpful feedback, and the
          community members who shared their pain points with us and tested the
          product.
        </p>
      </div>
    </>
