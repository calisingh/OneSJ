        ...
        >
          ...
          >
            <p>
              ...
              information that is collected and recorded by OneSJ and how we use
            ...
            <p>
              <b>Log Files.</b>
              <p>
                OneSJ follows a standard procedure of using log files. These
                files log visitors when they visit websites. All hosting
                companies do this and a part of hosting services' analytics. The
                information collected by log files includes referring/exit
                pages, time spent on the website, and the number of clicks on
                the components. The purpose of the information is for analyzing
                trends, administering the site, and tracking users' movement on
                the website.
              </p>
            </p>
            ...
            <p>
              ...
              <p>
                Another part of our priority is adding protection for minors
                using the site. We encourage parents and guardians to observe,
                participate in, and/or monitor and guide their online activity.
                <p>
                  OneSJ does not knowingly collect any Personal Identifiable
                  Information from children. If you think that your child
